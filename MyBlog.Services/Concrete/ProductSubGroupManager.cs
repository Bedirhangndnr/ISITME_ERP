...
namespace MyBlog.Services.Concrete
{
    public class ProductSubGroupManager:ManagerBase,IProductSubGroupService
    {
        ...
        public async Task<IDataResult<ProductSubGroupUpdateDto>> GetProductSubGroupUpdateDtoAsync(int ProductSubGroupId)
        {
            ...
            {
                return new DataResult<ProductSubGroupUpdateDto>(ResultStatus.Error, null, Messages.General.NotFound(isPlural: false, "Hasta Tipi"));
            }
        }
        ...
        public async Task<IDataResult<ProductSubGroupDto>> AddAsync(ProductSubGroupAddDto ProductSubGroupAddDto, string createdByName)
        {
            ...
            }, Messages.General.GiveMessage(addedProductSubGroup.CreatedByName, "Hasta Tipi", "Eklendi"));
        }
        ...
        public async Task<IDataResult<ProductSubGroupDto>> UpdateAsync(ProductSubGroupUpdateDto ProductSubGroupUpdateDto, string modifiedByName)
        {
            ...
            return new DataResult<ProductSubGroupDto>(ResultStatus.Success, new ProductSubGroupDto
            {
                Message= Messages.General.GiveMessage(productSubGroup.Title, "Hasta Tipi", "Güncellendi."),
                ProductSubGroup = updatedProductSubGroup,
                ResultStatus = ResultStatus.Success,
            }, Messages.General.GiveMessage(productSubGroup.Title, "Hasta Tipi", "Güncellendi."));
        }
        public async Task<IDataResult<ProductSubGroupDto>> DeleteAsync(int ProductSubGroupId, string modifiedByName)
        {
            ...
            {
                ProductSubGroup = null,
            }, Messages.General.GiveMessage(productSubGroup.Title, "Hasta Tipi", "Güncellenemedi."));
        }
        //public async Task<IDataResult<ProductSubGroupListDto>> GetAllByDeletedAsync()
        //{
        //    var ProductSubGroups = await UnitOfWork.ProductSubGroups.GetAllAsync(c=>c.IsDeleted, c => c.ProductSubGroup);
        //    if (ProductSubGroups.Count > -1)
        //    {
        //        return new DataResult<ProductSubGroupListDto>(ResultStatus.Success, new ProductSubGroupListDto
        //        {
        ...
        //    {
        //        ProductSubGroups = null,
        //    }, Messages.ProductSubGroup.NotFound(isPlural: true));
        //}

        //public async Task<IDataResult<ProductSubGroupListDto>> GetAllByNonDeletedAsync()
        //{
        //    var ProductSubGroups = await UnitOfWork.ProductSubGroups.GetAllAsync(c => !c.IsDeleted, c => c.ProductSubGroup);
        //    if (ProductSubGroups.Count > -1)
        //    {
        ...
        //public async Task<IDataResult<ProductSubGroupListDto>> GetAllByNonDeletedAndActiveAsync()
        //{
        //    var ProductSubGroups = await UnitOfWork.ProductSubGroups.GetAllAsync(c => !c.IsDeleted && c.IsActive);
        //    if (ProductSubGroups.Count > -1)
        //    {
        //        return new DataResult<ProductSubGroupListDto>(ResultStatus.Success, new ProductSubGroupListDto
        //        {
        ...
        //        }, Messages.ProductSubGroup.Delete(deletedProductSubGroup.CreatedByName));
        //    }
        //    return new DataResult<ProductSubGroupDto>(ResultStatus.Error, new ProductSubGroupDto
        //    {
        //        ProductSubGroup = null,
        //    }, Messages.ProductSubGroup.NotFound(isPlural: false));
        //}
        ...
        //        await UnitOfWork.SaveAsync();
        //        return new Result(ResultStatus.Success, Messages.ProductSubGroup.HardDelete(ProductSubGroup.CreatedByName));
        //    }
        //    return new Result(ResultStatus.Error, Messages.ProductSubGroup.NotFound(isPlural: false));
        //}
        ...
        //public async Task<IDataResult<ProductSubGroupDto>> ApproveAsync(int ProductSubGroupId, string modifiedByName)
        //{
        //    var ProductSubGroup = await UnitOfWork.ProductSubGroups.GetAsync(c => c.Id == ProductSubGroupId, c => c.ProductSubGroup);
        //    if (ProductSubGroup != null)
        //    {
        //        ProductSubGroup.IsActive = true;
        //        ProductSubGroup.ModifiedByName = modifiedByName;CustomerType
        //        ProductSubGroup.ModifiedDate = DateTime.Now;
        //        var updatedProductSubGroup = await UnitOfWork.ProductSubGroups.UpdateAsync(ProductSubGroup);
        //        await UnitOfWork.SaveAsync();
        //        return new DataResult<ProductSubGroupDto>(ResultStatus.Success, new ProductSubGroupDto
        //        {
        //            ProductSubGroup = updatedProductSubGroup
        //        }, Messages.ProductSubGroup.Approve(ProductSubGroupId));
        //    }

        //    return new DataResult<ProductSubGroupDto>(ResultStatus.Error, null, Messages.ProductSubGroup.NotFound(isPlural: false));
        //}
        ...
        //        {
        //            ProductSubGroup = deletedProductSubGroup,
        //        }, Messages.ProductSubGroup.UndoDelete(deletedProductSubGroup.CreatedByName));
        //    }
        //    return new DataResult<ProductSubGroupDto>(ResultStatus.Error, new ProductSubGroupDto
        //    {
        //        ProductSubGroup = null,
